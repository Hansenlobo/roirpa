...
intTotalProcess=last_row_1[0]
intTotalEmployee=last_row_1[1]
intTotalTime=last_row_1[2]/100
intSalary=last_row_1[3]
intCostBot=last_row_1[4]
intMaintainanceCost=last_row_1[5]
ListCurrentCostFTE=[]
ListHoursWeek =[]
ListCostWeek=[]
